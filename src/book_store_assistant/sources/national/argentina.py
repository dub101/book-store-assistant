...
_BASE_URL = "https://www.isbn.org.ar/web/buscar-detalle.php"


def _extract_field(html: str, label: str) -> str | None:
    """Try to pull a labelled value from the detail page HTML.

    The Argentine ISBN agency catalogue renders rows like:
