...
_BASE_URL = "https://isbnmexico.indautor.cerlalc.org/catalogo.php"


def _extract_field(html: str, label: str) -> str | None:
    """Try to pull a labelled value from the detail page HTML.

    The CERLALC/INDAUTOR catalogue renders rows like:
...
class MexicoISBNSource:
    ...
    def fetch(self, isbn: str) -> FetchResult:
        ...
        editorial = (
            ...
            or _extract_field(html, "Sello editorial")
